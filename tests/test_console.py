...
class Test_update(unittest.TestCase):
    ...
    def test_update_BaseModel(self):
        ...
        for j, k in zip(attr, value):
            with patch('sys.stdout', new=io.StringIO()) as f:
                HBNBCommand().onecmd("update " + i + " " + id_st + " " + j +
                                     " " + k)
        alldic = storage.all()
        ins = alldic[i + '.' + id_st[:-1]]
        for j, k, m in zip(attr, value, typeval):
    ...
    def test_update_User(self):
        ...
        value = ["My First Model", "123", "aka@gmail.com", "pswd", "fikri",
                 "Page"]
    ...
    def test_update_Place(self):
        ...
        attr = ["city_id", "user_id", "name", "description", "number_rooms",
                ...
                "longitude", "code"]
        value = ["686", "123", "fikri", "Nice", 5, 2, 15, 136,
                 8.7, 9.4, "988"]
    ...
    def test_update_Review(self):
        ...
        value = ["985", "7621", "Random Text", "My First Model", "123"]
        typeval = [str, str]
        with patch('sys.stdout', new=io.StringIO()) as f:
            HBNBCommand().onecmd("create " + i)
            id_st = f.getvalue()
